...
**Check your work:**
- [ ] Every rewrite explicitly asks for the reasoning before the final answer
- [ ] The prompt adds a verification step that would catch the original shortcut (show your arithmetic, check your units, list your steps)
- [ ] "Why this works" names a specific reasoning trigger, not a generic phrase
- [ ] You ran at least one rewrite and observed the model reason step by step before answering
...
**Check your work:**
- [ ] Each "Which needs..." answer names a specific technique (CoT, ToT, self-consistency, or plain prompting)
- [ ] The "Why?" ties the technique to a property of the problem (multi-step, multiple valid approaches, high-stakes)
- [ ] Where the simpler prompt is fine, you said so instead of over-engineering
- [ ] Your definitions match Module 4 — no swapping of CoT and ToT
...
**Check your work:**
- [ ] Step 1 pinpoints the exact arithmetic error (1/4 + 1/6 mis-added as 5/6)
- [ ] Step 2 verdict (systematic vs. random) is argued from the runs, not guessed
- [ ] Your fixed prompt was run and produced 2.4 hours — or you recorded what it produced and why
- [ ] The 5-run self-consistency table is filled and the verdict follows from that data
- [ ] Step 6 correctly states the limits: self-consistency only fixes random variance, not a systematic error
...
**Check your work:**
- [ ] Your example fails "confidently" — the reasoning looks plausible but the answer is wrong
- [ ] You ran it and confirmed it actually fails (not hypothetical)
- [ ] Your fix targets the specific failure mode rather than a generic "be more careful"
